...
### ⚠️ Это ЕДИНСТВЕННОЕ место где публикуется данная программа, если вы видите её в каких-либо youtube роликах, на подозрительных сайтах или вам кто-то присылает её в виде exe файла - это 100% ВИРУС или у вас пытатся украсть данные. Качайте программу ТОЛЬКО отсюда!
